<template>
  <header
    ref="header"
    :class="[
      'fixed left-0 right-0 top-0 z-50 w-full border-b border-dark-800/30 backdrop-blur transition-all duration-300',
      { 'translate-y-0 opacity-100 shadow-lg': visible, 'pointer-events-none -translate-y-full opacity-0': !visible }
    ]"
  >
    <div class="container mx-auto flex h-16 items-center justify-between px-4 md:px-8">
      ...
      <div class="flex items-center">
        ...
        <h1 class="text-lg font-semibold text-white">NexusHR</h1>
      </div>
      ...
      <nav class="hidden items-center md:flex">
        <ul class="flex space-x-8">
          <li>
            <a href="#" @click="handleNavClick" class="text-sm text-white hover:text-primary-400">Home</a>
          </li>
          <li>
            <a href="#features" @click="handleNavClick" class="text-sm text-gray-400 transition-colors hover:text-white">Features</a>
          </li>
          <li>
            <a href="#job-seekers" @click="handleNavClick" class="text-sm text-gray-400 transition-colors hover:text-white">Find Jobs</a>
          </li>
          <li>
            <a href="#employers" @click="handleNavClick" class="text-sm text-gray-400 transition-colors hover:text-white">For Recruiters</a>
          </li>
          <li>
            <a href="#contact" @click="handleNavClick" class="text-sm text-gray-400 transition-colors hover:text-white">About</a>
          </li>
        </ul>
      </nav>
      ...
      <div class="flex items-center">
        ...
        <button 
          ...
          class="mr-3 rounded-full p-2 text-gray-400 transition-colors hover:bg-dark-800 hover:text-white"
        >
          <svg 
            v-if="isDarkMode" 
        ...
        <!-- Sign In Button -->
        <a href="#" class="mr-3 hidden text-sm text-gray-400 transition-colors hover:text-white md:block">Sign In</a>
        ...
        <button 
          ...
          class="ml-4 rounded-full p-2 text-gray-400 transition-colors hover:bg-dark-800 hover:text-white md:hidden"
        >
          <svg 
      ...
      <div class="container mx-auto px-4 py-4">
        <ul class="space-y-4">
          ...
          <li class="border-t border-dark-800/30 pt-4">
            <a href="#" class="block text-sm text-gray-400 transition-colors hover:text-white">Sign In</a>
          </li>
        </ul>
      </div>
    </div>
